...
function CamelCase(str) {
  ...
  for (let i = 0; i < string.length; i++) {
    if (!(string[i].toLowerCase() >= "a" && string[i].toLowerCase() <= "z")) {
      camelCaseArray.push(i);
    }
  }

  if (camelCaseArray.length === 0) {
  ...
  for (let i = 0; i < camelCaseArray.length; i++) {
    ...
    for (let j = position; j < string.length; j++) {
      ...
      if (i == 0) {
        camelCaseString += string[j].toLowerCase();
      } else {
        if (toggleFlag == 0) {
          camelCaseString += string[j].toUpperCase();
        } else {
          camelCaseString += string[j].toLowerCase();
        }
      }
  ...
  for (let k = position; k < string.length; k++) {
    if (toggleFlag == 0) {
      camelCaseString += string[k].toUpperCase();
    } else {
      camelCaseString += string[k].toLowerCase();
    }
    position++;
    toggleFlag++;
  }
